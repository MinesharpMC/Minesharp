...
{
    internal static Dictionary<TPrimaryKey, Dictionary<TSecondaryKey, TValue>> ToNestedDictionary<TPrimaryKey, TSecondaryKey, TValue>(this IEnumerable<TValue> values, Func<TValue, TPrimaryKey> primarySelector, Func<TValue, TSecondaryKey> secondarySelector)
    {
